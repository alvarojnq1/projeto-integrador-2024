...
'Intestino grosso',
'Esôfago',
'É no intestino delgado onde a maioria dos nutrientes é absorvida para a corrente sanguínea');
...
'Absorção de nutrientes',
'O peristaltismo é o movimento de contração rítmica dos músculos que empurra o alimento ao longo do sistema digestório.');
...
'Estômago',
'Intestino grosso',
'É no intestino delgado onde ocorre a maior parte da digestão química dos alimentos, devido à ação de enzimas pancreáticas e intestinais');
...
'A amilase salivar é uma enzima que inicia a digestão do amido, um carboidrato presente nos alimentos.');
...
'Produção de suco pancreático',
'Absorção de nutrientes',
'O fígado é responsável pela produção da bile, que é armazenada na vesícula biliar e liberada no intestino delgado para ajudar na digestão das gorduras.');
...
'Os movimentos segmentares ajudam a misturar o alimento com sucos digestivos e a promover a absorção de nutrientes.');
...
'A bile emulsifica as gorduras, quebrando-as em gotículas menores para facilitar a digestão pelas enzimas.');
...
'O suco gástrico é produzido pelas glândulas do estômago e contém ácido clorídrico, que ajuda na digestão das proteínas, e pepsina, uma enzima digestiva.');

INSERT INTO perguntas VALUES (null,
'O que são as microvilosidades intestinais e qual é sua função?',
'Pequenas protuberâncias na mucosa do intestino delgado para aumentar a área de absorção',
...
'As microvilosidades intestinais aumentam a superfície de absorção no intestino delgado, facilitando a absorção de nutrientes.');

INSERT INTO perguntas VALUES (null,
'O que é a peritonite e como ela pode ocorrer?',
'Inflamação da membrana que reveste a cavidade abdominal, geralmente devido a uma infecção ou perfuração',
'Inflamação do revestimento do estômago devido ao consumo excessivo de alimentos ácidos',
'Inflamação do intestino delgado causada por uma infecção viral',
'Inflamação da vesícula biliar devido ao acúmulo de bile',
'A peritonite pode ocorrer devido a uma infecção bacteriana, lesão abdominal ou perfuração do trato gastrointestinal');
...
'Diverticulite é a inflamação ou infecção dos divertículos, pequenas bolsas que podem se formar ao longo da parede do intestino grosso.');
...
'As enzimas digestivas são proteínas que aceleram as reações químicas envolvidas na digestão, quebrando os alimentos em moléculas menores para absorção.');

INSERT INTO perguntas VALUES (null,
'O que é a síndrome do intestino irritável e quais são seus sintomas principais?',
'Distúrbio funcional do intestino com sintomas como dor abdominal, constipação e diarreia',
'Doença inflamatória crônica do intestino com sintomas como dor abdominal, diarreia e perda de peso',
...
' A síndrome do intestino irritável é um distúrbio gastrointestinal crônico que causa dor abdominal, constipação e/ou diarreia, sem danos físicos no intestino.');

INSERT INTO perguntas VALUES (null,
'O que é a doença celíaca e como ela afeta o sistema digestório?',
'Doença autoimune que danifica o revestimento do intestino delgado em resposta ao consumo de glúten',
...
'A doença celíaca é uma doença autoimune em que o sistema imunológico ataca erroneamente o revestimento do intestino delgado em resposta à ingestão de glúten.');

INSERT INTO perguntas VALUES (null,
'O que é a cirrose hepática e como ela afeta o funcionamento do fígado?',
'Cicatrização do fígado devido a danos crônicos, resultando em perda de função hepática',
...
'A cirrose hepática é uma condição na qual o tecido hepático normal é substituído por tecido cicatricial, levando à perda progressiva da função hepática.');

INSERT INTO perguntas VALUES (null,
'O que é a pancreatite aguda e quais são suas causas comuns?',
'Inflamação aguda do pâncreas devido a cálculos biliares ou consumo excessivo de álcool',
...
'A pancreatite aguda é uma inflamação súbita do pâncreas, muitas vezes causada por cálculos biliares ou consumo excessivo de álcool.');
...
'A esteatose hepática é o acúmulo excessivo de gordura no fígado, o que pode levar a inflamação e cicatrização, resultando em danos ao fígado.');

INSERT INTO perguntas VALUES (null,
'Qual cirurgia comprometeria mais a função do sistema digestório e por quê: a remoção dos centímetros iniciais do intestino delgado ou a remoção de igual porção do início do intestino grosso?',
'A remoção do duodeno seria mais drástica, pois nele ocorre a maior parte da digestão intestinal.',
'A remoção do duodeno seria mais drástica, pois nele ocorre a absorção de toda a água de que o organismo necessita para sobreviver.',
'A remoção do intestino grosso seria mais drástica, pois nele ocorre a maior parte da absorção dos produtos do processo digestório.',
'A remoção do intestino grosso seria mais drástica, pois nele ocorre a absorção de toda a água de que o organismo necessita para sobreviver.',
